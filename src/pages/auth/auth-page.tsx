...
export default function AuthPage() {
  ...
  return (
    <div className="w-screen h-screen lg:items-start lg:justify-start font-nunito flex items-center justify-center ">
      <div className={`hidden lg:block ${mode === 'login' ? 'lg:w-[65%]' : 'lg:w-[55%]'} lg:p-7 lg:pr-0 h-full transition-all`}>
        <img
      ...
      <div className={`flex items-center justify-center py-12 ${mode === 'login' ? 'lg:w-[35%]' : 'lg:w-[45%]'} lg:p-[5%] h-full transition-all duration-500 ${transitioning ? 'opacity-0' : 'opacity-100'}`}>
        {renderSubPage()}
      </div>
      <Toaster/>
    </div>
