              ...
              <>
                ...
                <div className="w-full md:w-1/2 p-3 pt-0 md:p-5 flex flex-col justify-start items-center h-full gap-4">
                      ...
                      {order.type === ORDER_TYPE.DELIVERY ? (
                        <>
                          ...
                          <span className="text-red-700">
                            {getEstimatedDeliveryTime(order.timeAdded, true)}{" "}
                            WIB
                          </span>
                        </>
                      ) : (
                        <>
                          ...
                          <span className="text-red-700">
                            {getEstimatedDeliveryTime(order.timeAdded, false)}{" "}
                            WIB
                          </span>
                        </>
                      )}
                  ...
                  <div className="w-full p-2 shadow-md rounded-xl flex gap-3 bg-white text-base">
                    <div className="flex w-1/2 h-10 rounded-md hover:bg-slate-200 hover:cursor-pointer justify-center items-center gap-3 transition-all duration-300 ease-in-out">
